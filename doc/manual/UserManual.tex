...
libSplash is a combined project of the Center for Information Services and HPC (ZIH) of the
...
To use libSplash in your application, the only include file necessary is \code{splash.h}.
...
queried continuously using \code{DataContainer::getNumElements} as well as
\code{DataContainer::getElement}.
